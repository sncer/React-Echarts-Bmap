$(function(){
	...
	var myChart2 = echarts.init(document.getElementById('mBox'));
	var pathSymbols = {
...
var option = {
  ...
  myChart2.setOption(option);      
    ...
    /*	 var myChart = echarts.init(document.getElementById('bar02'));
	 	var option = {
			    color: ['#0068b7','#05adb7','#e65551','#e2ac19','#21a8e7'],
			    tooltip : {
			        trigger: 'axis',
			    ...
			    series : [
			        {
						...
						　　　　　　　　　　　　　　label: {
						                        ...
						                        color: function(params) {
						                            ...
						                            var colorList = [
						                              '#0068b7','#05adb7','#e65551','#e2ac19','#6ed3f4',
						                            ];
...
//柱状图
    	 var myChart = echarts.init(document.getElementById('bar03'));
	 	var option = {
    color: colors,
    ...
    xAxis: [
        {
            ...
            axisPointer: {
                label: {
                    formatter: function (params) {
                        return '示例  ' + params.value
                            + (params.seriesData.length ? '：' + params.seriesData[0].data : '');
                    }
                }
            },
            data: ["2016-1", "2016-2", "2016-12"]
        },
        {
            type: 'category',
            axisTick: {
    ...
    series: [
        {
            ...
            xAxisIndex: 1,
            smooth: true,
            data: [2.6, 335.9, 90.0, 26.4, 28.7, 70.7, 175.6, 182.2, 48.7, 18.8, 6.0, 22.3]
        },
        {
            name:'2016',
            type:'line',
            smooth: true,
            data: [3.9, 35.9, 11.1, 18.7, 48.3, 69.2, 231.6, 46.6, 55.4, 18.4, 10.3, 56.7]
        }
    ]
};
myChart.setOption(option);	
